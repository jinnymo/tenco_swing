...
public class Bubble extends JLabel  implements Moveable{
	...
	private bubble.test.ex08.Player player;
	...
	public Bubble(bubble.test.ex08.Player player) {
	...
	public bubble.test.ex08.Player getPlayer() {
		return player;
	}

	public void setPlayer(bubble.test.ex08.Player player) {
		this.player = player;
	}
